...
/**
 * Adapted from GitHub repository tuanpi (no license given).
 * See: https://github.com/tuantvu/tuanpi/blob/master/SSD1306_I2C_Display.java
 *
 * @author Tuan Vu
 */
public class Display {
	 ...
	 * the Adafruit's library and I am using a hack to use WiringPi function similar to one in the original lib
	 * directly.
	 *
	 * @param width   Display width
	 * @param height  Display height
