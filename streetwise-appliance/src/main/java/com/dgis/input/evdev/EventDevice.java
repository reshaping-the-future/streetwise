...
// needs to be
// package com.dgis.input.evdev
// otherwise jni methods won't be found
...
interface IEventDevice {
	 ...
	 * @return The parameters, or null if there was an error. Modifications to this object will be reflected in the
	 * device.
	 */
...
public class EventDevice implements IEventDevice {
	...
	private InputEvent readEvent() {
		try {
			/* Read exactly the amount of bytes specified by InputEvent.STRUCT_SIZE_BYTES (intrinsic size of
			inputBuffer)*/
			inputBuffer.clear();
